...
$query="select a.couName,a.couNo,a.couCredit,b.teaNo,b.teaName,c.couCnt,d.couDay,convert(char,d.couTime,120) couTime from 
courseMessage as a ,teacherMessage as b, courseRelease as c,courseTime as d,courseSelect as e
where a.couNo= c.couNo And a.couNo=d.couNo AND c.couNo=d.couNo AND c.teaNo=b.teaNo AND e.stuNo='{$stuNo}' AND e.couNo=c.couNo";
