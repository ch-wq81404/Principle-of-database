...
$query="select appCouNo,convert(char,appTime,120)appTime,appCredit,statu from 
offsetCredits where stuNo='{$stuNo}'";
...
if(sqlsrv_has_rows($result)){
	...
	{
		$fileType = mb_detect_encoding($row['statu'], array('UTF-8','GBK','LATIN1','BIG5')) ;//找原来数据的编码方式
